...
def generate_public_layouts(project_path):
    generate_public_layout(project_path)
    generate_public_header_layout(project_path)
    generate_public_footer_layout(project_path)



def generate_public_header_layout(project_path):
    """
...
def generate_public_layout(project_path):
    """
    Genera el archivo dentro de la carpeta layouts.
    """
    print_message("Generando HeaderLayout.jsx...", CYAN)
...
def generate_public_footer_layout(project_path):
    """
    Genera el archivo dentro de la carpeta layouts.
    """

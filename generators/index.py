...
if __name__ == "__main__":
    ...
    if os.path.isdir(ruta):
        ...
        generate_repository_file(ruta, singular_name, plural_name, singular_name_kebab, plural_name_kebab, singular_name_snake, plural_name_snake, namespace, app_name)
